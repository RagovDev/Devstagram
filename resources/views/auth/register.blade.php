...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        <div class="md:w-6/12 p-5">
            <img src="{{asset('img/registrar.jpg')}}" alt="Imagen registro usuarios" class="rounded-lg shadow-xl">
        </div>
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('register') }}" method="POST">
                ...
                {{-- Es convencion que en los campos de los formularios que sean para confirmar contraseñas se coloque por name del input, 'password_conformation'. De esta mañana laravel interpreta el campo como un input de confirmacion de contraseña y nos ayuda con la validacion del mismo. --}}
                <div class="mb-5">
                    <label for="password_confirmation" class="mb-2 block uppercase text-gray-500 font-bold">
                        Repetir Password
                    </label>
                    <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Repite tu password de registro" class="border p-3 w-full rounded-lg @error('password') border-red-500 @enderror">
